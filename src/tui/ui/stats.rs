...
fn compute_protocol_stats(packets: &[crate::tui::collectors::packets::CapturedPacket]) -> Stats {
...
fn render_header(f: &mut Frame, area: Rect) {
    ...
    let header = Paragraph::new(Line::from(vec![
        ...
        Span::raw("│ "),
        Span::raw("[1] Dashboard  [9] DDoS Logs  [2] Connections  [9] DDoS Logs  [3] Interfaces  [9] DDoS Logs  [4] Packets  [9] DDoS Logs  "),
        Span::styled("[5] Stats  [9] DDoS Logs", Style::default().fg(Color::Yellow).bold()),
        Span::raw("  [6] Topology  [9] DDoS Logs  [7] Timeline  [9] DDoS Logs  [8] Insights  [9] DDoS Logs"),
        Span::raw("  │ "),
